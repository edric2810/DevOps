...
{{/*
Create Deployment config map common.
*/}}
{{- define "common.deployment.nameConfigMap" -}}
{{- $value := cat .Values.nameOverride "config" }}
{{- $value := $value | replace " " "-" }}
name: {{ $value }}
{{- end -}}

{{/*
Create Deployment secret common.
*/}}
{{- define "common.deployment.nameSecret" -}}
{{- $value := cat .Values.nameOverride "secret" }}
{{- $value := $value | replace " " "-" }}
name: {{ $value }}
{{- end -}}